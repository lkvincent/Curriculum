    ...
    <telerik:RadGrid ID="grdProfessional" runat="server" OnNeedDataSource="radGrid_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderText="获奖时间" DataField="ObtainTime" DataFormatString="{0:yyyy-MM-dd}">
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href="ChildProfessionalDetail.aspx?ID=<%#Eval("ID") %>" class="grid-edit"><span>查看</span></a>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" Width="40px" />
                    <ItemStyle HorizontalAlign="Left" Width="40px" />
                </telerik:GridTemplateColumn>
