<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginControl.ascx.cs" Inherits="XmutLuckV1.Manage.Enterprise.UserControl.LoginControl" %>
<div class="data-container">
    ...
    <div class="action-container">
        <div class="action-right">
            <asp:HyperLink ID="linkResetPassword" runat="server" NavigateUrl="~/Manage/Enterprise/ResetPassword.aspx"
