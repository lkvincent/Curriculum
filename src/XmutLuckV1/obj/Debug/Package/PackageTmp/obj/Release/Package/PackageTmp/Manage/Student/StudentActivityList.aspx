...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceAction" runat="server">
    <div class="left">
         ...
         <%--<asp:Button ID="btnImport" runat="server" OnClientClick="OpenPublishActivityList()" Text="应用活动"></asp:Button>--%>
        <input type="button" value="应用活动" onclick="OpenPublishActivityList()" />
    </div>
    <div class="right">
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentPlaceList" runat="server">
    ...
    <script type="text/javascript">
        function OpenPublishActivityList() {
            window.parent.tb_showIFrame("应用发布活动", "../Common/PublishActivityList.aspx?StudentNum=<%=CurrentAccount.UserName %>&TB_iframe=true&width=820&height=520", "");
        }
    </script>
</asp:Content>
