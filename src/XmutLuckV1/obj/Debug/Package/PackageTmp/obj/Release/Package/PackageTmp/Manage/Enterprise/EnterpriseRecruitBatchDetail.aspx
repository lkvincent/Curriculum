            ...
            <div class="container">
                <table>
                    <tr>
                        <th>批次名称:</th>
                        <td>
                            <asp:TextBox runat="server" ID="txtTitle" Width="220px" CssClass="edit-text"></asp:TextBox>
                        </td>
                        <th>批次描述:</th>
                        <td>
                            <asp:TextBox runat="server" ID="txtDescription" Width="400px" CssClass="edit-text"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
