<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterDetail.master" AutoEventWireup="true" CodeBehind="ChildActivityDetail.aspx.cs"
    Inherits="XmutLuckV1.Manage.Family.Children.ChildActivityDetail" Theme="FamilyManage" %>
                    ...
                    <div class="container">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Literal runat="server" ID="ltl_ActivityType_"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <th>活动时间从:
