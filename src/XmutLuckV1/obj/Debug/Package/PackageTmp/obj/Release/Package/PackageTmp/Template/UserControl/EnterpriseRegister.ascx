    ...
    <div class="container">
        ...
        <asp:PlaceHolder ID="placeRegisterContainer" runat="server">
            <div class="enterprise-content">
                <div>
                    <asp:TextBox ID="txt_Name_" runat="server" Width="300px" EmptyMessage="企业名称" CssClass="edit-text"></asp:TextBox>
                ...
                <div>
                    <asp:TextBox ID="txt_LicenseNo_" runat="server" Width="300px" EmptyMessage="营业执照号码" CssClass="edit-text"></asp:TextBox>
                ...
                <div>
                    <asp:TextBox ID="txt_Address_" runat="server" Width="300px" EmptyMessage="联系地址" CssClass="edit-text"></asp:TextBox>
                ...
                <div>
                    <asp:TextBox ID="txt_ContactPhoto_" runat="server" Width="300px" EmptyMessage="联系电话" CssClass="edit-text"></asp:TextBox>
                ...
                <div>
                    <asp:TextBox ID="txt_ContactName_" runat="server" Width="300px" EmptyMessage="联系人姓名" CssClass="edit-text"></asp:TextBox>
                ...
                <div>
                    <asp:TextBox ID="txt_Email_" runat="server" Width="300px" EmptyMessage="电子邮件" CssClass="edit-text"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rvcEmail" ControlToValidate="txt_Email_" runat="server"
                        ValidationGroup="register" CssClass="required" Display="Dynamic" ErrorMessage="<div class='error'><i class='msg-ico'></i><label>联系人姓名不能为空!</label></div>"></asp:RequiredFieldValidator>
                    <br class="clear" />
                </div>
                <div>
                    <asp:TextBox ID="txt_UserName_" runat="server" EmptyMessage="用户名" CssClass="edit-text"></asp:TextBox>
                ...
                <div>
                    <asp:TextBox ID="txt_Password_" runat="server" TextMode="Password" EmptyMessage="密码" CssClass="edit-text"></asp:TextBox>
                ...
                <div>
                    <asp:TextBox ID="txt_Password2_" runat="server" TextMode="Password" EmptyMessage="确认密码" CssClass="edit-text"></asp:TextBox>
