<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="ChildProjectList.aspx.cs" Inherits="XmutLuckV1.Manage.Family.Children.ChildProjectList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentHead" runat="server">
    <script type="text/javascript">
        function ViewDetail(projectId) {
            window.parent.tb_showIFrame("子女参与项目明细界面", "Children/ChildProjectDetail.aspx?ID=" + projectId + "&width=860&height=600&TB_iframe=true");
        }
    </script>
</asp:Content>
    ...
    <telerik:RadGrid ID="grdProject" runat="server" OnNeedDataSource="radGrid_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href="ChildProjectDetail.aspx?ID=<%#Eval("ID") %>"><span>查看</span></a>
                    </ItemTemplate>
