    ...
    <telerik:RadGrid ID="grdTeacherGroup" runat="server" OnItemDataBound="radGrid_ItemDataBound"
        ...
        <MasterTableView DataKeyNames="Code" AllowCustomPaging="True" AllowPaging="True">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="LastUpdateTime" HeaderText="最后修改时间" DataFormatString="{0:yyyy-MM-dd hh:mm}">
                        ...
                        <div class="container">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtName" runat="server" Width="240px" CssClass="edit-text" Text='<%#Eval("Name") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                   <th></th> 
                                    <td><asp:RequiredFieldValidator runat="server" ID="rqvName" ControlToValidate="txtName" Display="Dynamic" ErrorMessage="<span class='required'>职能组名称不能为空</span>"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    <th valign="top">职能组描述:</th>
                                    <td>
                                        <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Width="400px" Height="60" CssClass="edit-text" Text='<%#Eval("Description") %>'></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
