...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHead" runat="server">
    <script type="text/javascript">
        function OpenDetail(batchId, text) {
            parent.tb_showIFrame("应聘流程明细界面(" + text + ")", "RecruitFlow.aspx?RecruitBatchID=" + batchId + "&width=1050&height=580&TB_iframe=true");
        }
    </script>
</asp:Content>
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href="RecruitFlowDetailByBatch.aspx?BatchID=<%#Eval("ID") %>"><span>应聘批量处理</span></a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
