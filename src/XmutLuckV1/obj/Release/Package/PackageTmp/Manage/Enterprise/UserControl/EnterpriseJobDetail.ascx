    ...
    <div class="container">
        <table>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtContactName" runat="server" Width="295px"></asp:TextBox>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtTelephone" runat="server" Width="295px"></asp:TextBox>
    ...
    <div class="conatiner">
        <table>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtAgeScope" runat="server" Width="156px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtWorkPlace" runat="server" Width="478px"></asp:TextBox>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtSalaryScope" runat="server" Width="156px"></asp:TextBox>
