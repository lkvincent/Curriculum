                ...
                <div class="block tab-block">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txt_EvaluateFromTeacher_" runat="server" TextMode="MultiLine" Width="474px"
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txt_VerifyStatusReason_" runat="server" TextMode="MultiLine" Width="474px"
                                    Height="100px" CssClass="multi-edit-text"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
