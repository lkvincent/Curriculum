...
<div class="func-block user-detail">
            ...
            <div class="user-left">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_TeacherNum_" runat="server" Enabled="false" CssClass="edit-text"></asp:TextBox>
                        </td>
                        <th>
                            籍贯:
                        </th>
                        <td>
                            <asp:TextBox ID="txt_NativePlace_" runat="server" CssClass="edit-text"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <asp:TextBox ID="txt_NameZh_" runat="server" CssClass="edit-text"></asp:TextBox>
                        </td>
                        <th>
                            性别:
                        </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_MarjorName_" runat="server" CssClass="edit-text"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txt_School_" runat="server" Width="470px" Height="25px" CssClass="multi-edit-text"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <asp:TextBox ID="txt_ContactPhone_" runat="server" CssClass="edit-text"></asp:TextBox>
                        </td>
                        <th>
                            Email:
                        </th>
                        <td>
                            <asp:TextBox ID="txt_Email_" runat="server" CssClass="edit-text"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th class="multiLine">
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txt_Description_" runat="server" Width="470px" TextMode="MultiLine"
        ...
        <div class="container">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadNumericTextBox ID="rad_WorkingYear_" runat="server" NumberFormat-DecimalDigits="1" Width="170px">
                    ...
                    <td>
                        <asp:TextBox ID="txt_Telephone_" runat="server" Width="175px" Height="25px" CssClass="multi-edit-text"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="block course-list">
        ...
        <div class="container">
            <div class="course-data">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="drp_MarjorID_" runat="server" Width="145px">
                            </asp:DropDownList>
                        ...
                        <td>
                            <asp:DropDownList ID="drp_CourseType_" runat="server" Width="145px" AutoPostBack="true"
                                OnSelectedIndexChanged="drp_CourseType__SelectedIndexChanged">
                            </asp:DropDownList>
            ...
            <div class="action">
                <div class="left">
                    <asp:Button ID="btnNew" runat="server" Text="新增" OnClick="btnNew_Click" ValidationGroup="CourseGroup">
                    </asp:Button>
                </div>
                <br class="clear" />
            </div>
