<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterDetail.master" AutoEventWireup="true"
    CodeBehind="StudentActivityVerifyDetail.aspx.cs" Inherits="XmutLuckV1.Manage.Teacher.StudentActivityVerifyDetail" %>
                ...
                <div class="block tab-block">
                    <table>
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:Literal ID="ltl_ActivityType_" runat="server"></asp:Literal>
                            </td>
                        </tr>
                        <tr>
                            <th>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txt_EvaluateFromTeacher_" runat="server" TextMode="MultiLine" Width="474px" MaxLength="500"
                                    Height="100px" CssClass="multi-edit-text"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <th class="multiLine">
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txt_VerifyStatusReason_" runat="server" TextMode="MultiLine" Width="474px" MaxLength="500"
                                    Height="100px" CssClass="multi-edit-text"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
