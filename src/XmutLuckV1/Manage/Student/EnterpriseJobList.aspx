<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="EnterpriseJobList.aspx.cs" Inherits="XmutLuckV1.Manage.Student.EnterpriseJobList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHead" runat="server">
    <script type="text/javascript">
        ...
        function RequestNewJob(jobCode) {
            parent.ShowIframeForm('申请职位', 'RequestNewJob.aspx?jobCode=' + jobCode, '500px', '350px',
                {
                    hideOverFlow: true, isShowFooter: true
                });
        }
    </script>
</asp:Content>
        ...
        <MasterTableView>
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="">
                    ...
                    <ItemTemplate>
                        <a href='#' title="申请职位" onclick="RequestNewJob('<%#Eval("Code") %>')" class="grid-edit">
                            <span>申请职位</span>
                        </a>
                    </ItemTemplate>
                ...
                <telerik:GridBoundColumn DataField="JobRequestDescription" HeaderText="状态">
                    <HeaderStyle Width="85px" HorizontalAlign="Left" />
